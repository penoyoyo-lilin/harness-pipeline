---
name: code-frontend
description: React Next.js 前端编码专家 Agent（go-gin-react profile）。根据架构设计和 UI 规范实现前端代码，包括组件、页面、API 调用层和状态管理。
version: 1.0.0
...
# code-frontend — React Next.js 前端编码 Agent（go-gin-react）
